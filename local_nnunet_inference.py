...
class nnUNetPredictor(object):
    def __init__(self,
        ...
        self.resnet_pre_ckpt = resnet_pre_ckpt
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        for i, f in enumerate(use_folds):
            ...
            print("\n##########################\n"
                  f"Model Loaded from {join(model_training_output_dir, f'fold_{f}', checkpoint_name)}\n"
                  "############################\n"
                  )
        ...
        from models.build_model import build_network_architecture
        network = build_network_architecture(
            self.model_name,
            self.resnet_pre_ckpt,
