...
from local_nnunet_trainer import nnUNetTrainer
...
def get_trainer_from_args(dataset_name_or_id: Union[int, str],
    ...
    nnunet_trainer = nnUNetTrainer(plans=plans, configuration=configuration, fold=fold,
                                    dataset_json=dataset_json, unpack_dataset=not use_compressed, device=device,model_name=model_name,resnet_pre_ckpt=resnet_pre_ckpt)
...
def run_training(dataset_name_or_id: Union[str, int],
    ...
    if num_gpus > 1: 
        ...
        nnunet_trainer = get_trainer_from_args(dataset_name_or_id, configuration, fold, trainer_class_name,
                                               plans_identifier, use_compressed_data, device=device,model_name=model_name,resnet_pre_ckpt=resnet_pre_ckpt)
...
def run_training_entry():
    ...
    parser.add_argument('--resnet_pre_ckpt', type=str)
    ...
    run_training(args.dataset_name_or_id, args.configuration, args.fold, args.tr, args.p, args.pretrained_weights,
                 ...
                 resnet_pre_ckpt=args.resnet_pre_ckpt
                 )
